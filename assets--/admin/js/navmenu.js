...
SiteRoot = 'http://proeducationgroup.com/';
...
editorblock.hide();
   ...
   var mname= editorblock.find('.mname').val().trim();
	...
	$('.addtonavmenu').click(function(e){
											nestlelistchanged=true;
											  var menuname=$('#menuTitle').val();
											  var menu=$('#menuLink').val();
											  if(!menu || !menuname){ alert('Enter Title & Link');return false;}
