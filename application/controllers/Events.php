...
class Events extends CI_Controller {
    ...
    public $tbl_name ='true_events';
    //public $tbl_payment ='true_payments';

    public function index()
    {
    	$data = array();
    	$data['pageContent'] = $this->sectionsettings_model->getSectionDataCollection('events');

        /* SEO : Meta data : Start */
        $data['meta_title'] = $this->sectionsettings_model->getSectionSettingByKey('events','meta_title');
        $data['meta_description'] = $this->sectionsettings_model->getSectionSettingByKey('events','meta_description');
        $data['meta_key'] = $this->sectionsettings_model->getSectionSettingByKey('events','meta_key');
        /* SEO : Meta data : End */

    	$data['records'] = getDataCollection($this->tbl_name);    	
		$this->load->view('front/include/header',$data);
		$this->load->view('front/events/index',$data);
	...
	public function detail($slug)
    {
    	$data = array();
        $data['pageContent'] = $this->sectionsettings_model->getSectionDataCollection('events');
    	$dataCollection = $this->events_model->getSinglePageDataCollection($slug);
		...
		$this->load->view('front/include/header',$data);		
		$this->load->view('front/events/detail',$data);		
		$this->load->view('front/include/footer');		
	}
