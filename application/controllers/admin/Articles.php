...
class Articles extends CI_Controller
{
    ...
    public $tbl_name = "articles";
    public $tbl_cat  = "articles_cat";
        ...
        if (!empty($post_data))
        {
            ...
            if ($this->form_validation->run() != FALSE)
            {
                ...
                if ($insert_id > 0)
                {
                    ...
                    {
                        $featured_img      = do_upload('articles');
    ...
    public function addcategory()
    {
        ...
        if(!empty($post_data)) {        
            ...
            if($this->form_validation->run() != FALSE)
            {
                ...
                if ($insert_id > 0)
                {
                    ...
                    redirect('admin/articles/category','refresh');
                }
            }
        }
        $this->load->view('admin/include/header');
        $this->load->view('admin/include/main-header');
        $this->load->view('admin/include/main-sidebar',$data);
        $this->load->view('admin/articles/add-category',$data);
        $this->load->view('admin/include/main-footer');
        $this->load->view('admin/include/footer');
    }
    ...
    public function editcategory()
    {
        ...
        $this->load->view('admin/include/main-header');
        $this->load->view('admin/include/main-sidebar',$data);
        $this->load->view('admin/articles/edit-category',$data);
        $this->load->view('admin/include/main-footer');
        $this->load->view('admin/include/footer');
    }
