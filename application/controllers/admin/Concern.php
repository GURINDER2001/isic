...
class Concern extends CI_Controller {
	...
	public $tbl_name = "tbl_concern_type";
	...
	public function index()
	{
		...
		$this->load->view('admin/concern/list',$data);
	...
	public function add()
	{
		...
		if(!empty($post_data)) {        
			...
			if($this->form_validation->run() != FALSE)
			{
				...
				if ($insert_id > 0)
                {
					...
					redirect('admin/concern','refresh');
                }
			}
		}
		...
		$this->load->view('admin/include/main-header');
		$this->load->view('admin/include/main-sidebar',$data);
		$this->load->view('admin/concern/add',$data);
		$this->load->view('admin/include/main-footer');
		$this->load->view('admin/include/footer');
	}
	...
	public function edit()
	{
		...
		$this->load->view('admin/include/main-header');
		$this->load->view('admin/include/main-sidebar',$data);
		$this->load->view('admin/concern/edit',$data);
		$this->load->view('admin/include/main-footer');
		$this->load->view('admin/include/footer');
	}
