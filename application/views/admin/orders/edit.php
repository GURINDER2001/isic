                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                foreach($cards as $card)
                                                {
                                                    $checked = '';
                                                    $offer_price = '';
                                                    if(array_key_exists($card->id, $affiliates_cards))
                                                    {
                                                        $checked = 'checked="checked"';
                                                        $offer_price = $affiliates_cards[$card->id];
                                                    }
                                                    ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="card_selected[]" value="<?=$card->id; ?>" <?=$checked; ?>></td>
                                                        <td><?=!empty($card->featured_img)?'<img src="'.base_url($card->featured_img).'" width="50">':''; ?></td>
                                                        <td><?=$card->name; ?></td>
                                                        <td>₹<?=$card->price; ?></td>
                                                        <td><input type="number" name="offer_price[<?=$card->id; ?>]" class="form-control" value="<?=$offer_price; ?>"></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <div class="row">
                                        ...
                                        $str = '<a href="'.base_url('cards/selection?aftoken='.$token).'"><img src="'.base_url('assets/img/logo.png').'" alt="Button" title="Button"></a>';
                                        ?>
                                        <div class="col-md-12">
