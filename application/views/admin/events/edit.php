...
<div class="content-wrapper">
  <section class="content-header">
      <h1>Edit Event <small>it all starts here</small></h1>
      <ol class="breadcrumb">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <?php echo form_input(array('id' => 'event_date', 'name' => 'event_date','class'=>'form-control datepicker input-md','placeholder'=>'yyyy-mm-dd','value' => set_value('event_date', isset($event_date)?$event_date:""))); ?>
                                </div>
