...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Campus <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="form-group">
                        ...
                        <div class="pac-card">
                            <div id="type-selector" class="pac-controls">
                                <input type="radio" name="locality" class="flat-red" value="City" <?=(!empty($locality) && $locality=='City')?'checked="checked"':''; ?>> City &nbsp;

                                <input type="radio" name="locality" value="University" class="flat-red" <?=(!empty($locality) && $locality=='University')?'checked="checked"':''; ?>> Universities &nbsp;

                                <input type="radio" name="locality" class="flat-red" value="Sub-locality" <?=(!empty($locality) && $locality=='Sub-locality')?'checked="checked"':''; ?>> Sub-locality &nbsp;
                          </div>
                        </div>
                    </div> 
                    <div class="form-group">
...
<?php
$options = '';
if(!empty($options_countries))
{
    foreach ($options_countries as $key => $value)
    {
