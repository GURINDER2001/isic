...
<div class="content-wrapper">
  <section class="content-header">
      <h1>Edit Page <small>Content will be managed as per brand.</small></h1>
      <ol class="breadcrumb">
                    ...
                    <form action="" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="name" value="<?=set_value('name', isset($name)?$name:" ");?>" id="name" class="form-control input-md" placeholder="Title">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" name="type" value="plain" <?=(empty($type) || $type=='plain')?'checked="checked"':''; ?>> Plain
                            <input type="radio" name="type" value="html" <?=(empty($type) || $type=='html')?'checked="checked"':''; ?>> HTML
                            <?php echo form_error('type'); ?>
                        </div>

                        <div class="form-group" id="blah_container">
                            <img id="blah" src="<?=!empty($featured_img)?base_url($featured_img):base_url('assets/admin/images/no_image.gif'); ?>" alt="Featured Image" class="img2" />
                        </div>
