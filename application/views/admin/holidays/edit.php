...
<div class="content-wrapper">
  <section class="content-header">
      <h1>Edit Holiday <small>it all starts here</small></h1>
      <ol class="breadcrumb">
                      ...
                      <form method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group date">
                                  ...
                                  <input type="text" name="name" value="<?=!empty($name)?$name:""; ?>" id="name" class="form-control input-md" placeholder="Title">
                              </div>
