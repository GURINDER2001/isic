...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Edit Discount <small>it all starts here</small></h1>
    <ol class="breadcrumb">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group date">
                                  ...
                                  <?php echo form_dropdown('country_id',getCountriesOptions(),$country_id,array('id' => 'country_id','class'=>'form-control select2')); ?>
                              </div>
                          ...
                          <div class="form-group" id="blogCategoriesSection" <?=(!empty($display_section_arr) && !in_array('blog',$display_section_arr))?'style="display:none;"':''; ?>>
