...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit Articles <small>it all starts here</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Articles Management</a></li>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <?php echo form_multiselect('category[]', $categoryOptions,set_value('category',isset($category)?explode(",", $category):""),'id="category" class="form-control input-md select2"'); ?>
                              </div>
