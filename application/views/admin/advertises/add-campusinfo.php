...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Add Program Info By Campus <small>it all starts here</small></h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#"> Programs Management</a></li>
      <li class="active"> Add Program Info By Campus</li>
    </ol> 
  </section>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group date">
                          ...
                          <?php echo form_dropdown('campus_id', $options_campus,set_value('campus_id',!empty($campus_id)?$campus_id:""),'id="campus_id" class="form-control select2" required="required"'); ?>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 ">
                          <div class="form-group">
                              <?php echo $date_type = !empty($date_type)?$date_type:'automatic'; ?>
                      ...
                      <div class="col-sm-12">
                          <hr/>
                          <?php $visibility = !empty($visibility)?$visibility:'yes'; ?>
