<div class="content-wrapper">
    <section class="content-header">
        <h1>Partners Page Settings <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                          ...
                          <div class="col-md-12">
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <?php echo form_input(array('id' => 'video_section_heading', 'name' => 'video_section_heading','class'=>'form-control input-md','placeholder'=>'Heading','value' => set_value('video_section_heading', !empty($video_section_heading)?$video_section_heading:''))); ?>
                                    </div>
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <?php echo form_input(array('id' => 'summary_section_heading', 'name' => 'summary_section_heading','class'=>'form-control input-md','placeholder'=>'Heading','value' => set_value('summary_section_heading', !empty($summary_section_heading)?$summary_section_heading:''))); ?>
                                    </div>
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-10"><?php echo form_textarea(array('id' => 'summary_content', 'name' => 'summary_content','class'=>'form-control input-md','placeholder'=>'Content...','rows'=>3,'value'=>(!empty($rec['summary_content'])?$rec['summary_content']:''))); ?></div>
								</div>
							</div>
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    <h3>Partner Left and Right Image Section</h3>
                                </div>
                                <div class="field_wrapper" id="fTabs_wrapper">
                                    <?php
                                    $featured_tabs_content = !empty($featured_tabs_content)?unserialize($featured_tabs_content):array();
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    <h3>Content Summary First</h3>
                                </div>
                                <div class="field_wrapper" id="conSun_wrapper">
                                    <?php
                                    $featured_tabs_content = !empty($featured_tabs_content)?unserialize($featured_tabs_content):array();
                                    if(!empty($featured_tabs_content))
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <a href="javascript:void(0);" id="con_sum" class="add_button" title="Add field">
                                                        <img src="<?=base_url('assets/admin/images/add.png');?>"/>
                                                    </a>
                                                </div>
                                            </div>
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    <h3>Content Summary Second </h3>
                                </div>
                                <div class="field_wrapper" id="conSun2_wrapper">
                                    <?php
                                    $featured_tabs_content = !empty($featured_tabs_content)?unserialize($featured_tabs_content):array();
                                    if(!empty($featured_tabs_content))
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <a href="javascript:void(0);" id="con_sum2" class="add_button" title="Add field">
                                                        <img src="<?=base_url('assets/admin/images/add.png');?>"/>
                                                    </a>
                                                </div>
                                            </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
        ...
        $(add_fTabs).click(function()
        {
            ...
            {
                var blah = 'blah6a'+y;
                var fieldHTMLfTabs = '<div class="row"> <div class="col-md-11"> <div class="row stepsBox"> <div class="col-md-3"> <div id="'+blah+'_container"> <img class="img2" id="'+blah+'" src="'+base_url+'/assets/admin/images/no_image.gif" alt="your image"/> </div></div><div class="col-md-9"> <div class="row"> <div class="col-md-2"><label for="fTabs_icons">Slider Image::</label></div><div class="col-md-10"><input name="slider_icons[]" type="file" class="form-control pull-right" id="slider_icons" onchange="checkPhoto(this,\''+blah+'\')"></div></div></div></div></div><div class="col-md-1"> <a href="javascript:void(0);" id="delete_fTabs" class="remove_button" title="Remove field"> <img src="'+base_url+'/assets/admin/images/delete.png"> </a> </div></div>'; //New input field html 
		...
		var con_sum = $('#con_sum'); //Add button selector
        var conSun_wrapper = $('#conSun_wrapper'); //Input field wrapper
        
        //Once add button is clicked
        $(con_sum).click(function()
        {
           // alert('aaaaa2');
			//Check maximum number of input fields
            if (y < maxField)
            {
                var blah = 'blah6a'+y;
                var fieldHTMLfTabs = '<div class="row"><div class="col-md-11"><div class="row stepsBox"><div class="col-md-3"><div id="'+blah+'_container"><img class="img2" id="'+blah+'" src="'+base_url+'/assets/admin/images/no_image.gif" alt="your image"/> </div></div><div class="col-md-9"><div class="row"><div class="col-md-2"><label for="fTabs_icons">Image:</label></div><div class="col-md-10"><input name="pget_icons[]" type="file" class="form-control pull-right" id="pget_icons" onchange="checkPhoto(this,\''+blah+'\')"></div></div><div class="row"><div class="col-md-2"><label for="pget_title">Title:</label></div><div class="col-md-10"><input type="text" name="pget_title[]" value="" id="pget_title" class="form-control input-md" placeholder="Title..."></div></div><div class="row"><div class="col-md-2"><label for="fTabs_content">Content:</label></div><div class="col-md-10"><textarea rows="3" name="pget_content[]" value="" id="pget_content" class="form-control input-md" placeholder="Content..."></textarea></div></div></div></div></div><div class="col-md-1"><a href="javascript:void(0);" id="delete_fTabs" class="remove_button" title="Remove field"> <img src="'+base_url+'/assets/admin/images/delete.png"> </a> </div></div>'; //New input field html 

                y++; //Increment field counter
                $(conSun_wrapper).append(fieldHTMLfTabs); //Add field html
            }
            else
            {
                alert('Exceed maximum limit of records, Only '+maxField+' records are allowed');
		...
		//Once remove button is clicked
        $(conSun_wrapper).on('click', '.remove_button', function(e) {
            e.preventDefault();
            //alert( $(this).closest(".col-md-12").html());
            $(this).closest(".row").remove(); //Remove field html
            y--; //Decrement field counter
		...
		var con_sum2 = $('#con_sum2'); //Add button selector
        var conSun_wrapper2 = $('#conSun2_wrapper'); //Input field wrapper
        
        //Once add button is clicked
        $(con_sum2).click(function()
        {
           // alert('aaaaa2');
			//Check maximum number of input fields
            if (y < maxField)
            {
                var blah = 'blah6a'+y;
                var fieldHTMLfTabs = '<div class="row"><div class="col-md-11"><div class="row stepsBox"><div class="col-md-3"><div id="'+blah+'_container"><img class="img2" id="'+blah+'" src="'+base_url+'/assets/admin/images/no_image.gif" alt="your image"/> </div></div><div class="col-md-9"><div class="row"><div class="col-md-2"><label for="why_icons">Image:</label></div><div class="col-md-10"><input name="why_icons[]" type="file" class="form-control pull-right" id="why_icons" onchange="checkPhoto(this,\''+blah+'\')"></div></div><div class="row"><div class="col-md-2"><label for="why_title">Title:</label></div><div class="col-md-10"><input type="text" name="why_title[]" value="" id="why_title" class="form-control input-md" placeholder="Title..."></div></div><div class="row"><div class="col-md-2"><label for="why_content">Content:</label></div><div class="col-md-10"><textarea rows="3" name="why_content[]" value="" id="why_content" class="form-control input-md" placeholder="Content..."></textarea></div></div></div></div></div><div class="col-md-1"><a href="javascript:void(0);" id="delete_fTabs" class="remove_button" title="Remove field"> <img src="'+base_url+'/assets/admin/images/delete.png"> </a> </div></div>'; //New input field html 

                y++; //Increment field counter
                $(conSun_wrapper2).append(fieldHTMLfTabs); //Add field html
            }
            else
            {
                alert('Exceed maximum limit of records, Only '+maxField+' records are allowed');
		...
		//Once remove button is clicked
        $(conSun_wrapper2).on('click', '.remove_button', function(e) {
            e.preventDefault();
            //alert( $(this).closest(".col-md-12").html());
            $(this).closest(".row").remove(); //Remove field html
            y--; //Decrement field counter
