...
$layout = !empty($layout)?$layout:0;
?>
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Partners Page <small>it all starts here</small></h1>
        <ol class="breadcrumb">
    							...
    							<div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <?php echo form_input(array('id' => 'offer_heading', 'name' => 'offer_heading','class'=>'form-control input-md','placeholder'=>'Heading...','value' => set_value('offer_heading', !empty($offer_heading)?$offer_heading:''))); ?>
                                        </div>
                                        <?php echo form_error('offer_heading'); ?>
                                    </div>
                                </div>
    							...
    							<div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <?php echo form_input(array('id' => 'keyelement_section_heading', 'name' => 'keyelement_section_heading','class'=>'form-control input-md','placeholder'=>'Heading...','value' => set_value('keyelement_section_heading', !empty($keyelement_section_heading)?$keyelement_section_heading:''))); ?>
                                        </div>
