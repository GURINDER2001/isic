...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Affiliate Partner <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                foreach($cards as $card)
                                                {
                                                    ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="card_selected[]" value="<?=$card->api_card_id; ?>"></td>
                                                        <td><?=!empty($card->featured_img)?'<img src="'.base_url($card->featured_img).'" width="50">':''; ?></td>
                                                        <td><?=$card->name; ?></td>
                                                        <td>₹<?=$card->price; ?></td>
                                                    <td><input type="number" name="offer_price[<?=$card->api_card_id; ?>]" class="form-control" value=""></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><input type="checkbox" name="shipment_selected[]" value="pickup"></td>
                                                <td>Pick-Up</td>
                                                <td>₹0.00</td>
                                            </tr>
                                            <tr>
                                                <td><input type="checkbox" name="shipment_selected[]" value="delivery"></td>
                                                <td>Delivery</td>
                                                <td width="20%"><input type="number" name="shipping_price[delivery]" class="form-control" value="100"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
