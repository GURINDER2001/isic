...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Add Bulk Coupons <small>it all starts here</small></h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#"> Coupons Management</a></li>
      <li class="active"> Add Bulk Coupon</li>
    </ol> 
  </section>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <?php echo form_input(array('type'=>'number','id' => 'coupon_count', 'name' => 'coupon_count','class'=>'form-control input-md','placeholder'=>'Coupon Counts','required'=>'required','value' => set_value('coupon', isset($coupon)?$coupon:100 ))); ?>
                                </div>
                                <?php echo form_error('coupon_count'); ?>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
