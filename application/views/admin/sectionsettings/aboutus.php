<div class="content-wrapper">
	<section class="content-header">
	    <h1>AboutUs Settings<small>it all starts here</small></h1>
	    <ol class="breadcrumb">
                                                    ...
                                                    <div class="row logosBox">
                                                        <div class="col-md-3">
                                                            <div id="blah5<?=$k; ?>_container">
                                                                ...
                                                                <input type="hidden" id="partner_logo_image" name="partner_logo_image[]" value="<?=!empty($rec['logo'])?$rec['logo']:'';?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="row mb-5">
                                                                <div class="col-md-2"><label for="key_elements_icons">Icon:</label></div>
                                                                <div class="col-md-10"><input name="partner_logo_icons[]" type="file" class="form-control pull-right" id="partner_logo_icons" onchange="checkPhoto(this,'blah5<?=$k; ?>')"></div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2"><label for="partner_logo_url">Url:</label></div>
                                                                <div class="col-md-10"><?php echo form_input(array('id' => 'partner_logo_url', 'name' => 'partner_logo_url[]','class'=>'form-control input-md','placeholder'=>'Url...','value'=>(!empty($rec['url'])?$rec['url']:''))); ?></div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row logosBox">
                                                        <div class="col-md-3">
                                                            <div id="blah5_container">
                                                                ...
                                                                <input type="hidden" id="partner_logo_image" name="partner_logo_image[]">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <div class="row mb-5">
                                                                <div class="col-md-2"><label for="partner_logo_icons">Icon:</label></div>
                                                                <div class="col-md-10"><input name="partner_logo_icons[]" type="file" class="form-control pull-right" id="partner_logo_icons" onchange="checkPhoto(this,'blah5')"></div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-2"><label for="partner_logo_title">Title:</label></div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2"><label for="partner_logo_title">Url:</label></div>
                                                                <div class="col-md-10"><?php echo form_input(array('id' => 'partner_logo_title', 'name' => 'partner_logo_url[]','class'=>'form-control input-md','placeholder'=>'Url...','value'=>(!empty($rec['url'])?$rec['url']:''))); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
