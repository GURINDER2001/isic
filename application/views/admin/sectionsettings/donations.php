<div class="content-wrapper">
    <section class="content-header">
        <h1>Donations Settings <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body pad">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div>
                                        <h3>Donation Amounts Options</h3></div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="field_wrapper">
								...
								{
									$i = 1;
									$amountArr = explode(",",$donation_amount);
									if(!empty($amountArr))
									{
										foreach ($amountArr as $val)
										{
											?>
								            <div class="col-md-12">
								                <div class="col-md-9">
								                    <div class="form-group">
								                        <div class="input-group date">
								                            ...
								                            <?php echo form_input(array('type'=>'number','id' => 'donation_amount', 'name' => 'donation_amount[]','class'=>'form-control input-md','placeholder'=>'Donation amount options','value'=>(!empty($val)?$val:''))); ?>
								                        </div>
								                        <?php echo form_error('donation_amount'); ?>
								                    </div>
								                </div>
								                <div class="col-md-3">
								                    <?php
													...
													{
														?>
								                        <a href="javascript:void(0);" class="add_button" title="Add field"><img src="<?=base_url('assets/admin/images/add.png');?>"/></a>
								                        <?php
													}
													else
													{
														?>
								                        <a href="javascript:void(0);" class="remove_button" title="Delete field"><img src="<?=base_url('assets/admin/images/delete.png');?>"/></a>
								                        <?php
													}
													?>
								                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var fieldHTML = '<div class="col-md-12"><div class="col-md-9"><div class="form-group"><div class="input-group date"><div class="input-group-addon"><i class="fa fa-dollar"></i></div><input type="number" name="donation_amount[]" value="" id="donation_amount" class="form-control input-md" placeholder="Donation amount options"></div></div></div><div class="col-md-3"><a href="javascript:void(0);" class="remove_button" title="Delete field"><img src="<?=base_url('
        assets / admin / images / delete.png ');?>"/></a></div>'; //New input field html 
        ...
        $(wrapper).on('click', '.remove_button', function(e) {
            ...
            $(this).closest(".col-md-12").remove(); //Remove field html
