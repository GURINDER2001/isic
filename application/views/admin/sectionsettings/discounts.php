<div class="content-wrapper">
    <section class="content-header">
        <h1>Discounts Settings <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body pad">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea name="page_content" class="ckeditor form-control" rows="2" placeholder="Enter ..."><?php echo set_value('page_content', !empty($page_content)?$page_content:''); ?></textarea>
                                </div>
