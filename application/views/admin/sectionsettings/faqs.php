<div class="content-wrapper">
	<section class="content-header">
	    <h1>Testimonials Settings<small>it all starts here</small></h1>
	    <ol class="breadcrumb">
	        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
	        <li><a href="#">Testimonials Setting</a></li>
	            ...
	            <div class="box">
	                ...
	                <div class="box-body pad">
	                    <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Promotional Image 1: </label>
                                </div>

                                <div class="form-group" id="blah2_container">
                                    <img id="blah2" src="<?=!empty($promotional_image1)?base_url($promotional_image1):base_url('assets/admin/images/no_image.gif'); ?>" alt="Promotional Image 1" class="img2" />
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                        ...
                                        <input name="promotional_image1" type="file" class="form-control pull-right" id="promotional_image1" onchange="checkPhoto(this,'blah2')">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Promotional Image 2: </label>
                                </div>

                                <div class="form-group" id="blah3_container">
                                    <img id="blah3" src="<?=!empty($promotional_image2)?base_url($promotional_image2):base_url('assets/admin/images/no_image.gif'); ?>" alt="Promotional Image 2" class="img2" />
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                        ...
                                        <input name="promotional_image2" type="file" class="form-control pull-right" id="promotional_image2" onchange="checkPhoto(this,'blah3')">
                                    </div>
                                </div>
                            </div>
