...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Edit Voucher <small>it all starts here</small></h1>
    <ol class="breadcrumb">
          ...
          <div class="box">
            <div class="box-body pad">
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      <label>Voucher (Comma seperated lists):</label>
                      <div class="input-group date">
                          <div class="input-group-addon">
                              <i class="fa fa-file-text-o"></i>
                          </div>
                      <?php echo form_textarea(array('id' => 'voucher', 'name' => 'voucher','class'=>'form-control input-md','placeholder'=>'Voucher','value' => set_value('voucher', isset($voucher)?$voucher:"" ))); ?>
                      </div>
