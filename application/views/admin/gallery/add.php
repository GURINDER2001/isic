...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Add Gallery <small>it all starts here</small></h1>
    <ol class="breadcrumb">
                      ...
                      <form action="" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                                ...
                                <div class="form-check form-switch">
                                  <input class="form-check-input" type="checkbox" name="type" id="is_video" value="1">
                          ...
                          <div id="videoUrlBox" class="form-group" style="display:none;">
                              <label>Video Url (YouTube):</label>
                              <div class="input-group date">
                                  <div class="input-group-addon">
                                      <i class="fa fa-file-text-o"></i>
                                  </div>
                                  <?php echo form_input(array('id' => 'video_url', 'name' => 'video_url','class'=>'form-control input-md','placeholder'=>'Video Embedded Url','value' => set_value('video_url', isset($video_url)?$video_url:"" ))); ?>
                              </div>
