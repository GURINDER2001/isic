...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add College <small>it all starts here</small></h1>
        <ol class="breadcrumb">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php echo form_input(array('id' => 'mobile', 'name' => 'mobile','class'=>'form-control input-md','placeholder'=>'Mobile','value' => set_value('mobile', !empty($mobile)?$mobile:"" ), 'required' => 'required')); ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $institution_type = !empty($institution_type)?$institution_type:'School'; ?>
                                    <div class="checkbox">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php echo form_input(array('type'=>'password', 'id' => 'password', 'name' => 'password','class'=>'form-control input-md','placeholder'=>'Password','required'=>'required')); ?>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="logo" type="file" class="form-control pull-right" id="logo" required="required" onchange="checkPhoto(this)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="form-group clearfix">
                                    <label>Summary <span class="astrick">*</span></label>
                                    <textarea id="summary" name="summary" placeholder="Place some text here" required="required" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo set_value('summary', isset($summary)?$summary:""); ?></textarea>
