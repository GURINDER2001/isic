...
<div class="content-wrapper">
  <section class="content-header">
      <h1>Add Insurance <small>it all starts here</small></h1>
      <ol class="breadcrumb">
                      ...
                      <form method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <?php echo form_dropdown('layout', $layoutOptions,set_value('layout',isset($layout)?$layout:""),'id="layout" class="form-control input-md select2"'); ?>
                              </div>
                          ...
                          <div id="basic-content">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <?php echo form_multiselect('features[]', $featureOptions,set_value('features',isset($feature)?$feature:""),'id="feature" class="form-control input-md select2"'); ?>
                                  </div>
