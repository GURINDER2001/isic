                ...
                <div class="col-sm-12">
                    ...
                    <div class="tabs-per">
                        <ul class="nav nav-tabs">
                            <li class="tabs-1"><a class="active" data-toggle="tab" href="javascript:;">Card Type </a></li>
                            <li class="tabs-2"><a data-toggle="tab" href="javascript:;">Personal Details </a></li>
                            <li class="tabs-3"><a data-toggle="tab" href="javascript:;">Services</a></li>
                            <li class="tabs-4"><a data-toggle="tab" href="javascript:;">Delivery and Payment</a></li>
                            <li class="tabs-5"><a data-toggle="tab" href="javascript:;">Completion</a></li>
                        </ul>
                    </div>
                </div>
            </div>
