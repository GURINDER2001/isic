                ...
                <div class="col-sm-12">
                    ...
                    <div class="steps-nav">
                        <ul class="nav nav-progress">
                            ...
                            <li><a href="<?=base_url('cards/summary'); ?>">Summary</a></li>
                                                ...
                                                <h2>Delivery Method</h2>
                                                    <div class="form-group-n">
                                                        <label for="delivery_option_pickup">
                                                            <input type="radio" name="delivery_option" id="delivery_option_pickup" value="Pickup"  /> Personal Pickup (for free) ISIC India Office (IInd Floor, DLF Cyber Greens, Tower C DLF Phase-III, Gurgaon, Haryana-122002)
                                                        </label>
                                                    </div>
                                                    <div class="form-group-n">
                                                        <?php $delivery_charge = $this->session->userdata('delivery_charge'); ?>
                                                        <label for="delivery_option_courier"><input type="radio" name="delivery_option" id="delivery_option_courier" value="Courier" /> Courier Service <span class="color-change-n">(+ ₹ <?=$delivery_charge; ?>)</span></label>
                                                    </div>
                                                <hr class="lin1" />
                                                <h2>Payment Method</h2>
                                                <div class="col-lg-6 col-md-6 col-sm-6 pull-left">
                                                    <div class="form-group-n"><label for="payment_option_OPTCRDC"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTCRDC" value="OPTCRDC">Credit Card</label></div>
                        		         	  		<div class="form-group-n"><label for="payment_option_OPTDBCRD"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTDBCRD" value="OPTDBCRD">Debit Card</label></div>
                        		         	  		<div class="form-group-n"><label for="payment_option_OPTNBK"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTNBK" value="OPTNBK">Net Banking</label></div>
                        		         	  		<div class="form-group-n"><label for="payment_option_OPTCASHC"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTCASHC" value="OPTCASHC">Cash Card</label></div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 pull-left">
                                                    <div class="form-group-n"><label for="payment_option_OPTMOBP"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTMOBP" value="OPTMOBP">Mobile Payments</label></div>
                        		         	  		<div class="form-group-n"><label for="payment_option_OPTEMI"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTEMI" value="OPTEMI">EMI</label></div>
                        							<div class="form-group-n"><label for="payment_option_OPTWLT"><input class="payOption" type="radio" name="payment_option" id="payment_option_OPTWLT" value="OPTWLT">Wallet</label></div>
                                                </div>
                                            ...
                                            <div class="text">
                                                ...
                                                <h2>Note</h2>
                                                    <div class="form-group not-1">
                                                        <textarea name="message" id="message" class="form-control" cols="30" rows="3" style="height:81px;" required="" data-error="Please enter your message"
