...
class Paypal_lib{
    ...
    function __construct(){
        ...
        $this->CI->load->model('sectionsettings_model');
        

        $credentials = $this->CI->sectionsettings_model->getSectionDataCollection('credentials');

       // print_r($credentials);

       // $sanbox = $this->CI->config->item('sandbox');
        $sanbox = (!empty($credentials['paypal_mode']) && $credentials['paypal_mode']=='sandbox')?TRUE:FALSE; 
        ...
        $businessEmail = ($sanbox == TRUE)?$credentials['paypal_sandbox_email']:$credentials['paypal_live_email'];
    ...
    {
        $this->CI->load->view('front/include/header');
        echo '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";  
        echo '<section class="login-banner-main" onLoad="document.forms[\'paypal_auto_form\'].submit();">
       ...
       // $this->button('Click here if you\'re not automatically redirected...');
        ...
        echo '</body></html>';
        $this->CI->load->view('front/include/footer');
